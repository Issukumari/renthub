...
describe('HomeComponent', () => {
  ...
  it('should load highlighted listings on init', () => {
    const highlightedListings = [{ id: 1, location: 'Location A', price: 100, amenities: [] }];
  ...
  it('should load paginated listings on init', () => {
    const paginatedListingsResponse = { listings: [{ id: 1, location: 'Location A', price: 100, amenities: [] }], totalPages: 1 };
